    ...
    <div className="absolute inset-0 bg-slate-100/50 dark:bg-slate-900/50 backdrop-blur-md flex flex-col items-center justify-center z-30 p-4 animate-fade-in">
      <div className="text-center bg-white/80 dark:bg-gray-800/80 p-8 rounded-2xl shadow-2xl max-w-lg">
        ...
        <p className="text-lg md:text-xl text-slate-600 dark:text-slate-300 mb-8">
         Bem-vindo(a). Antes de começar, respire.
         Talvez você vá precisar disso. Este é um jogo de movimento constante.
         As regras existem, mas nenhuma será explicada aqui Interprete os sinais, sinta o ritmo e descubra quando agir ou não.
         Acompanhe. Observe. Cada instante revela algo. Quando estiver pronto(a), pressione Iniciar.
        </p>
        <button
          onClick={onStart}
